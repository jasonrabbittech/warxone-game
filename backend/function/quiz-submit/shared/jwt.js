 ...
 * @param {string} userId - User ID
 * @param {object} extra - Additional payload fields (may include ver for rotation)
 * @returns {string} Refresh token
 */
function signRefreshToken(userId, extra = {}) {
  return signToken({ sub: userId, type: 'refresh', ...extra }, REFRESH_TOKEN_EXPIRY);
}
